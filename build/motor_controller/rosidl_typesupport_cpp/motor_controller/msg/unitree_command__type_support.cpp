...
static const _UnitreeCommand_type_support_symbol_names_t _UnitreeCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_controller, msg, UnitreeCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_controller, msg, UnitreeCommand)),
  }
};
...
{
  return &::motor_controller::msg::rosidl_typesupport_cpp::UnitreeCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motor_controller, msg, UnitreeCommand)() {
  return get_message_type_support_handle<motor_controller::msg::UnitreeCommand>();
}
