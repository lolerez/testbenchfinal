...
#include "motor_controller/msg/detail/unitree_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motor_controller::msg::UnitreeCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const motor_controller::msg::UnitreeCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_controller::msg::UnitreeCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UnitreeCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const motor_controller::msg::UnitreeCommand *>(
...
static size_t _UnitreeCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UnitreeCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UnitreeCommand__callbacks = {
...
static rosidl_message_type_support_t _UnitreeCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UnitreeCommand__callbacks,
...
{
  return &motor_controller::msg::typesupport_fastrtps_cpp::_UnitreeCommand__handle;
}
